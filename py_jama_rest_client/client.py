...
class JamaClient:
    ...
    def __handle_response_status(response):
        ...
        raise JamaAPIException("{} error".format(status),
                               status_code=status,
                               reason=response.reason)
